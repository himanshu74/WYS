...
namespace WYS.DataLayer.SqlHelper
{
    ...
    // ReSharper restore ConvertToStaticClass
    {
            ...
            SqlConnectionOwnership connectionOwnership)
        {
            ...
            try
            {
                ...
                if (
                    cmd.Parameters.Cast<SqlParameter>().Where(
                        commandParameter => commandParameter.Direction != ParameterDirection.Input).Count() > 0)
                {
                    canClear = false;
                }
    ...
    // ReSharper restore ConvertToStaticClass
    {
        ...
        public static SqlParameter[] GetCachedParameterSet(string connectionString, string commandText)
        {
            ...
            var cachedParameters = _paramCache[hashKey] as SqlParameter[];
